...
const staticAssets = new Map([
  ...
  ["/guided-work.js", "guided-work.js"],
  ["/guided-work-ui.js", "guided-work-ui.js"],
...
function getPluginReadiness(requestUrl) {
  ...
  return {
    ...
    demoFinishChecklistPrepared: getDemoCockpit().demoFinishChecklistPrepared,
    demoFinishChecklistStatus: getDemoCockpit().demoFinishChecklistStatus,
    nextDemoFinishStep: getDemoCockpit().nextDemoFinishStep,
    ...
    productiveCentralDesignUsabilityDiagnosis: getDemoCockpit().productiveCentralDesignUsabilityDiagnosis,
    ...
    productiveCentralDemoFinalReviewDecision: getDemoCockpit().productiveCentralDemoFinalReviewDecision,
    productiveCentralDemoFinalReviewDecisionPrepared:
