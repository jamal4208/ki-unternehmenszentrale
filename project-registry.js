...
const PROJECT_REGISTRY = [
  ...
  createProject({
    ...
    verificationSource: "Von Jamal bestätigte technische Health-Momentaufnahme für V6.44.1 (PR #1)",
    ...
    remoteRefs: {
      "origin/main": "1f4f96d",
      "baseline/private-health-expansion-2026-07-11": "28cdcf7",
    },
    baselineCommit: "26f65fe",
    workingTreeStatus: "SAUBER_ZUM_LETZTEN_BESTÄTIGTEN_PRÜFZEITPUNKT",
    testCommand: "npm test",
    testStatus:
      "BESTÄTIGT_ERFOLGREICH: Check-Logik OK; exportReadiness tests passed; Consent-Persistenz OK; Preview-Demodaten und Check-Datum OK; Static build erfolgreich",
    currentStatus:
      "Preview-Vertrauensfix aus PR #1 technisch bestätigt und in die private Baseline übernommen.",
    currentGoal: "Technischen Pilotstand kontrolliert prüfen, ohne fachliche oder öffentliche Freigabe abzuleiten.",
    nextSafeStep: "Nächsten tatsächlichen Preview-Blocker aus dem Kernfluss einzeln prüfen.",
    ...
    notes: [
      ...
      "PR #1 gemergt: Preview Demodaten kennzeichnen und Check-Datum aktualisieren.",
      "Merge-Commit 28cdcf7; Arbeitscommit 8eadc46; Remote-Baseline auf 28cdcf7; origin/main bewusst 1f4f96d.",
      "Demo-Profil und Demo-Beraterin sichtbar gekennzeichnet; Check-Folgedatum relativ und nicht mehr statisch veraltet.",
      "Keine API, kein Deployment und keine echten Kundendaten.",
    ],
  }),
  createProject({
  ...
  createProject({
    ...
    notes: [
      ...
      "Gemeinsamer technischer Basisstand wurde durch Health-PR #1 aktualisiert.",
    ],
  }),
  createProject({
