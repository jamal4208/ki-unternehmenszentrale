...
check("75. Health-Repository wird von den neuen HeyGen-Modulen nicht berührt (kein Pfad, kein Schreibzugriff)", () => {
  ["heygen-job-package.js", "heygen-connector.js", "heygen-job-result.js", "heygen-backup.js", "heygen-store.js"].forEach((file) => {
...
check("79. keine Canva-/Shopify-Route oder -Logik wurde durch Phase B verändert", () => {
  ...
  const heygenFiles = ["heygen-job-package.js", "heygen-connector.js", "heygen-job-result.js", "heygen-backup.js", "heygen-store.js"];
  heygenFiles.forEach((file) => {
    const source = fs.readFileSync(path.join(__dirname, file), "utf8");
...
check("HeyGen-Connector enthält keinen direkten Netzwerkaufruf (kein http/https-Client, kein fetch)", () => {
  ["heygen-job-package.js", "heygen-connector.js", "heygen-job-result.js"].forEach((file) => {
    const source = fs.readFileSync(path.join(__dirname, file), "utf8");
