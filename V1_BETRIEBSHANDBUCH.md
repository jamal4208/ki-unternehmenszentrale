...
- **V7.1 Phase C** (Canva als zweiter kontrollierter Design-Connector, `CONTROLLED_CONNECTOR_HANDOFF`, dieselbe neutrale Testmandantenbasis wie Phase B.1) ist lokal umgesetzt und mit 1165 automatisierten Prüfpunkten getestet, **jedoch noch nicht committed, gepusht oder deployt**; sieben getrennte Freigabestufen (Briefing, Assets/Rechte, externe Übertragung, Kostenrahmen, Canva-Übergabe, Designkandidat-Auswahl, Edit-/Speichervorschau); kein API-Key gespeichert, kein echtes Canva-Design in diesem Umsetzungsauftrag erstellt, keine Veröffentlichung; Kunden erhalten weiterhin keinen Canva-Zugang; HeyGen und Shopify unverändert – wartet auf Jamals manuelle Abnahme und Commit-Prüfung
...
- Canva produktiv ein Design erstellen, bearbeiten, speichern, extern übertragen oder veröffentlichen (Phase C bereitet ausschließlich ein geprüftes, kontrolliertes Designauftragspaket und dessen Hand-off vor; die tatsächliche Aktion liefe über einen externen Connector erst nach separater Jamal-Freigabe; im ersten realen Pilot ausschließlich Designkandidaten generieren und einen auswählen, keine Brand-Template- oder Edit-Transaktion)
- Echte Kunden anlegen oder Kunden einen HeyGen-/Canva-Zugang, ein echtes Kundenportal oder eine Veröffentlichungsfreigabe geben (Phase B.1/C kennen ausschließlich dieselben zwei neutralen Testmandanten ohne echte Kundendaten)
