...
- Kunden eine bestehende interne Fachroute, ein Fachauftrags-/Werkzeug-/Veröffentlichungsangebot oder Billing erreichen lassen (Schritt 3 liefert ausschließlich Login/Konto-/Sitzungsinformation im Kundenportal `/portal`; keine Business-Funktion ist für Kunden erreichbar)
