...
function runTests() {
  ...
  check("64 GET-Routen bleiben erhalten (Phase C: +2 GET Execution-Status/-Ergebnis, Phase D: +1 GET Executor-Registry, Phase E: +1 GET Freeze-Status, V7.1 Phase A: +5 GET Dokumente/Tools/Plugin-Gateway/Tool-Routing/Backup-Export, V7.1 Phase B: +3 GET HeyGen-Status/Jobpakete/Backup-Export, V7.1 Phase B.1: +5 GET Agentur-Mandantenbasis/Pilot-Review/Backup-Export, V7.1 Phase C: +3 GET Canva-Status/Jobpakete/Backup-Export, V7.1 Phase C.1: +1 GET Pilot-Ergebnisakten-Liste; die Einzelabruf-/Feedback-GET-Routen laufen wie bei bestehenden Einzelressourcen über routePrefixHandlers und werden hier konventionsgemäß nicht mitgezählt)", () => assert.strictEqual(routeCount, 64));
